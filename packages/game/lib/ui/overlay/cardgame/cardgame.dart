...
class CardGameOverlay extends StatefulWidget {
  CardGameOverlay() : super(key: UniqueKey());

  @override
  State<CardGameOverlay> createState() => _CardGameOverlayState();
}

class _CardGameOverlayState extends State<CardGameOverlay>
