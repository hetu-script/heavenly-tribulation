...
金：幻化出飞剑进行攻击和格挡。和剑修的区别在于金元素法术召唤出的飞剑无法获得身上装备的武器的加成，相反，可以获得元素类法宝的加成。进阶为雷

水：减少对方生命上限，增加自己生命上限。进阶为风、冰

木：使对方中毒，使自身每回合生命恢复。进阶为

火：直接伤害对方，或者增加自身行动速度。进阶为

土：使对方无法行动。或增加自身防御。进阶为沙、玉
