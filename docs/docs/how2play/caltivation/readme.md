...
4，卡牌本身也可提升等级并增强其属性，每张卡牌可以升级 5 次，升级后卡牌名字后会显示+1，提升至最高等级后的两张相同名字的卡牌，可以进行融炼，便有一定几率直接获得更高境界的卡牌，或者获得一张同境界不同名字的卡牌，但也有可能会融炼失败。融炼时获得自身流派和境界的卡牌的几率较高。
...
| 占卜     | 4    | 4    | 4    | 4    | 4    | 20   | ✗          |
| 神通     | 4    | 4    | 4    | 4    | 4    | 20   | ✗          |
| 当前合计 | 36   | 72   | 108  | 144  | 180  |      |            |
| 最终合计 | 90   | 180  | 270  | 360  | 450  |      |            |
...
金：幻化出飞剑进行攻击和格挡。和剑修的区别在于金元素法术召唤出的飞剑无法获得身上装备的武器的加成，相反，可以获得元素类法宝的加成。
...
古代的任何神、圣、妖、魔，统称古神。每种古神都有自己的形态、技能等等。参考[化神](oldgod.md)。

本质是一种改造基因强化肉体的路径。

## 炼魂 vitality - 对应属性：意志

上古流传下来的原始之道，擅长制作魂幡，懂得召唤和控制灵魂之力，以及毒、血、肉、骨相关的生灵法术。
