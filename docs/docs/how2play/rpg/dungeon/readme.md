...
秘境在地图上是隐藏的，每年只有固定的月份才会出现。每个秘境的出现月份不同。

进入秘境后，如果退出，就不能再次进入。但不退出时可以选择消耗秘境石继续从头开始秘境。

进入秘境时可以选择境界。无境界秘境可以免费进入。
...
1: 提交一件指定稀有度的装备或秘籍。换取一件对应稀有度的丹药。

2: 失去生命，获得一件等级和境界高于当前地牢的装备或秘籍。
