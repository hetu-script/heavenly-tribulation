...
门派的类型和流派类似于《群星》中的国策，会对门派内的建筑，以及成员的活动，提供数值和属性加成

无为 所有冥想类活动效率 +50%，修炼经验需求 -20%
长生 灵光恢复速度 +50%，成员寿命 +30%
修真 功法合成成功率 +30%，战斗经验 +50%
任侠 招募散修成功率 +50%，城市间移动速度 +30%
权霸 城市防御力 +30%，情报获取范围 +50%
财富 交易利润 +30%，建筑维护费用 -30%
欢愉 角色好感度增长 +50%，事件触发概率 +30%

此外，门派的类型和流派也决定了随机故事剧情的种类。

## 门派的法令

法令类似于临时性的国策，可以在一段时间内提供数值和属性加成。
...
| 职级 | 境界需求 | 职位 | 职位变种 | 权力范围 | 晋升功勋要求 | 期望每月功勋 | 期望晋升月数 |
| ---- | -------- | ---- | -------- | -------- | ------------ | ------------ | ------------ |
| 0    | 无       | 杂役 |          |          | 200          | 16           | 12           |
| 1    | 凝气     | 执事 |          |          | 700          | 32           | 21           |
| 2    | 筑基     | 总管 | 护法总管 | 建筑     | 1800         | 48           | 37           |
| 3    | 结丹     | 堂主 | 巡按堂主 | 城市     | 4300         | 64           | 67           |
| 4    | 成婴     | 长老 | 供奉长老 | 多个城市 | 10600        | 80           | 132          |
| 5    | 化神     | 掌门 |          |          |              |              |              |

注意这里的功勋**不累计**，也就是说每次晋升会扣掉职级对应的那么多功勋。
