...
对于玩家而言，可以修建和升级任意建筑。
对于NPC而言，一定会优先修建门派类型和流派对应的特色建筑。
世界生成时，门派总堂固定拥有类型对应的特色建筑，门派据点固定拥有流派对应的特色建筑。

与此同时，门派类型和流派类似群星的国策。会对建筑和生产提供数值和属性的加成。例如：

- 升级消耗材料 -50%
- 升级所需时间 -50%
- 建筑日常维护消耗 -30%
- 建筑内生产/打造效率 +30%（产出品质或数量）

## 无为 - daostele - 问道碑

在问道碑处打坐冥想可以直接通过明悟获得指定功法卡牌。

### 升级

冥想时可以更具体的指定想要获得的功法卡牌范围、类型和词条。

## 长生 - exparray - 聚灵阵

在聚灵阵打坐冥想可以将灵光转化为经验值。聚灵阵可以定期积攒灵光。灵光消耗完毕，只能花费灵石才能继续修炼，或者等下个月灵光恢复，或者前往其他城市。
...
在 NPC 处可以购买秘籍并获得随机功法，每个月会刷新商店。并提供功法打造功能。
...
可以为角色提供住宅之外的休息场所，并且可以快速回复大量生命和获得额外生命。
...
可以制作法器，这是一种特殊的战斗的卡牌（消耗，但可以通过再次灌灵补充次数），由装备转化而来，和符箓类似，有使用次数，需要在灌灵池补充灵气。
...
可以通过占卜获得关于世界上其他角色和门派的情报。

可以知道自身隐藏属性的数值：
问自己：运气、悟性、寿元
问他人：魅力偏好、修真偏好，门派偏好
问门派：门派类型。外交关系。（只能在角色自身有门派才会有这个选项）
