...
这些文档可以让你从总体上理解本项目下，和我正在设计的部分系统有关系的部分。目前只是规划阶段，只需要理解现有系统，不要修改任何文件。
...
@plan/battle_card_equipment_overview.md  这个文档可以让你从总体上理解本项目下，和我正在设计的部分系统有关系的部分。目前只是规划阶段，只需要理解现有系统，不要修改任何文件。