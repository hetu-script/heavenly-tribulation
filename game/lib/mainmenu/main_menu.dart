...
class _MainMenuState extends State<MainMenu> with RouteAware {
  ...
  DebugMenuStates _debugState = DebugMenuStates.main;
  void setDebugMenuState(DebugMenuStates state) {
    _debugState = state;
    setState(() {});
  }
                          ...
                          MainMenuStates.main => [
                              Padding(
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    setMenuState(MainMenuStates.game);
                                  },
                                  child: Label(
                              ...
                              Padding(
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    setMenuState(MainMenuStates.editor);
                                  },
                                  child: Label(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: switch (_debugState) {
                          DebugMenuStates.main => [
                              Padding(
                                padding: const EdgeInsets.only(top: 20.0),
                                child: ElevatedButton(
                                  onPressed: () {
                                    setDebugMenuState(DebugMenuStates.debug1);
                                  },
                                  child: Label(
                          ...
                          DebugMenuStates.debug1 => [
                              ...
                              Padding(
                                ...
                                child: ElevatedButton(
                                  ...
                                  child: Label(
                                    engine.locale('debug.cultivation'),
                                    width: 150.0,
                                    textAlign: TextAlign.center,
                                  ),
                                ),
                              ...
                              Padding(
                                ...
                                child: ElevatedButton(
                                  ...
                                  child: Label(engine.locale('debug.construct'),
                                      width: 200.0,
                                      textAlign: TextAlign.center),
                                ),
                              ),
                              ...
                              Padding(
                                ...
                                child: ElevatedButton(
                                  ...
                                  child: Label(engine.locale('debug.dialog'),
                                      width: 200.0,
                                      textAlign: TextAlign.center),
                                ),
                              ),
                              ...
                              Padding(
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    setDebugMenuState(DebugMenuStates.main);
                                  },
