...
import '../../ui/view/character/information/character.dart';
import '../../config.dart';
import '../../ui/view/character/builds/build.dart';
import '../../ui/view/character/stats/status.dart';
...
class HeroInfoPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final charStats =
        engine.hetu.invoke('getCharacterStats', positionalArgs: [heroData]);
        ...
        children: [
          Padding(
            ...
            child: Avatar(
              ...
              name: heroData['name'],
              image: AssetImage('assets/images/avatar/${heroData['icon']}'),
            ),
          ),
          Expanded(
            child: Column(
