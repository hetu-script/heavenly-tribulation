...
class _GameUIOverlayState extends State<GameUIOverlay> {
  ...
  Widget build(BuildContext context) {
    ...
    final enableTrade = context.watch<MerchantState>().enableTrade;
    final enableReplenish = context.watch<MerchantState>().enableReplenish;
    final merchantEnableSteal = context.watch<MerchantState>().enableSteal;
    ...
    for (final panel in visiblePanels.keys) {
      ...
      switch (panel) {
        ...
        case ViewPanels.alchemy:
          panels.add(AlchemyDialog(locationData: arguments?['location']));
      }
    }
          ...
          children: [
            ...
            if (merchantData != null && showMerchant)
              MerchantDialog(
                ...
                enalbeReplenish: enableReplenish,
                enalbeSteal: merchantEnableSteal,
              ),
            if (showItemSelect)
              ItemSelectDialog(
