  ...
  Future<void> _initEngine() async {
    ...
    engine.registerSceneConstructor(Scenes.battle, (arguments) async {
      return BattleScene(
        ...
        isPractice: arguments['isPractice'] ?? false,
    ...
    engine.hetu.interpreter.bindExternalFunction(
        'getDeckMinSizeForRank',
        ({positionalArgs, namedArgs}) =>
            GameLogic.getDeckMinSizeForRank(positionalArgs.first),
        override: true);

    engine.hetu.interpreter.bindExternalFunction('estimateItemPriceByKind', (
        {positionalArgs, namedArgs}) {
      return GameLogic.estimateItemPriceByKind(
    ...
    engine.hetu.interpreter.bindExternalFunction('Game::showBattle', (
      ...
      final arg = {
        ...
        'isPractice': namedArgs['isPractice'] ?? false,
        'onBattleStart': namedArgs['onBattleStart'],
        'onBattleEnd': namedArgs['onBattleEnd'],
        'background': namedArgs['background'],
      };
